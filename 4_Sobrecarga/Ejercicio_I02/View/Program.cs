...
namespace View
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Dolar billeteEnDolares = 100;

            //Euro billeteEnEuros = (Euro)billeteEnDolares;



            //Console.WriteLine(billeteEnDolares.GetCantidad());
            //Console.WriteLine(Peso.GetCotizacion());

            //Console.WriteLine(unDolar.GetCantidad());
